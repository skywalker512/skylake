...
> = Required<PlatePluginKey> & {
  ...
  Nullable<{
     ...
     * props as parameter. If object, its value will be shallow merged to the old props.
     */
     ...
     * `editor` and `plugin`. The returned value will be deeply merged to the plugin.
     */
    then?: (
      editor: E,
...
export type WithPlatePlugin<
  ...
  V extends Value = Value,
  E extends PlateEditor<V> = PlateEditor<V>
> = WithRequired<PlatePlugin<P, V, E>, 'type' | 'options' | 'inject' | 'editor'>
